    ...
    clusterConfiguration:
      ...
      apiServer:
        ...
        extraArgs:
          ...
          service-cluster-ip-range: {{ .Values.connectivity.clusterNetwork.services.cidrBlocks | first }}
        extraVolumes:
        - name: auditlog
      ...
      controllerManager:
        extraArgs:
          ...
          cluster-cidr: {{ .Values.connectivity.clusterNetwork.pods.cidrBlocks | first }}
          feature-gates: CronJobTimeZone=true
      scheduler:
        extraArgs:
          authorization-always-allow-paths: "/healthz,/readyz,/livez,/metrics"
      ...
      networking:
        serviceSubnet: {{ join "," .Values.connectivity.clusterNetwork.services.cidrBlocks }}
    files:
