...
| `global.providerSpecific.instanceMetadataOptions.httpPutResponseHopLimit` | **HTTP Put Response Hop Limit** - The number of allowed network hops from the instance to the metadata service.|**Type:** `number`<br/>**Default:** `2`|
