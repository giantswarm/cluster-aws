...
| `global.connectivity.dns.wildcardCnameTarget` | **Wildcard CNAME Target** - Override the wildcard CNAME record value (default: ingress.clusterBaseDomain)|**Type:** `string`<br/>**Example:** `"gateway"`<br/>|
