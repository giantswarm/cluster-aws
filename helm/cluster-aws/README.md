...
| `global.controlPlane.machineHealthCheck.maxUnhealthy` | **Maximum unhealthy nodes** - Remediation (= machine deletion) is only performed if at most `maxUnhealthy` machines are unhealthy.|**Type:** `[string]`<br/>**Example:** `"40%"`<br/>|
