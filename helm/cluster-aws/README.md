...
| `global.providerSpecific.instanceMetadataOptions.httpPutResponseHopLimit` | **HTTP Put Response Hop Limit** - The number of allowed network hops from the instance metadata service to the instance.|**Type:** `number`<br/>**Default:** `2`|
