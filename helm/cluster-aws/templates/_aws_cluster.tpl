{{- define "aws-cluster" }}
{{- $baseDomain := include "cluster.connectivity.baseDomain" $ -}}
{{- if and (regexMatch "\\.internal$" (required "global.connectivity.baseDomain is required" $baseDomain)) (eq (required "global.connectivity.dns.mode required" .Values.global.connectivity.dns.mode) "public") }}
