...
- export NO_PROXY=127.0.0.1,localhost,svc,local,169.254.169.254,{{ $.Values.connectivity.network.vpcCidr }},{{ join "," $.Values.connectivity.clusterNetwork.services.cidrBlocks }},{{ join "," $.Values.connectivity.clusterNetwork.pods.cidrBlocks }},{{ include "resource.default.name" $ }}.{{ $.Values.baseDomain }},elb.amazonaws.com,{{ $.Values.connectivity.proxy.noProxy }}
- export http_proxy={{ $.Values.connectivity.proxy.httpProxy }}
- export https_proxy={{ $.Values.connectivity.proxy.httpsProxy }}
- export no_proxy=127.0.0.1,localhost,svc,local,169.254.169.254,{{ $.Values.connectivity.network.vpcCidr }},{{ join "," $.Values.connectivity.clusterNetwork.services.cidrBlocks }},{{ join "," $.Values.connectivity.clusterNetwork.pods.cidrBlocks }},{{ include "resource.default.name" $ }}.{{ $.Values.baseDomain }},elb.amazonaws.com,{{ $.Values.connectivity.proxy.noProxy }}
